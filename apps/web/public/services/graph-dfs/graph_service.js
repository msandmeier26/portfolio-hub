...
async function createGraphServiceModule(moduleArg = {}) {
  var moduleRtn;
...
function findWasmBinary() {
  ...
  if (Module['locateFile']) {
    return locateFile('graph_service.wasm');
  }

  // Use bundler-friendly `new URL(..., import.meta.url)` pattern; works in browsers too.
  return new URL('graph_service.wasm', import.meta.url).href;
...
export default createGraphServiceModule;
